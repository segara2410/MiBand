 ...
 */
package custom.freeyourgadget.MiBandApp.daogen;
...
public class GBDaoGenerator {
    ...
    private static final String MAIN_PACKAGE = "custom.freeyourgadget.MiBandApp";
...
//        A:\Documents\Github\MiBand-ft-Polar\app\src\main\java
        new DaoGenerator().generateAll(schema, "A:\\Documents\\Github\\MiBand-ft-Polar\\app\\src\\main\\java");
    }
    ...
    private static void addAlarms(Schema schema, Entity user, Entity device) {
        ...
        alarm.implementsInterface("custom.freeyourgadget.MiBandApp.model.Alarm");
