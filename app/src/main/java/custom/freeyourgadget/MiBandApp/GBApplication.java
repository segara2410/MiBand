...
package custom.freeyourgadget.MiBandApp;
...
import custom.freeyourgadget.MiBandApp.database.DBOpenHelper;
import custom.freeyourgadget.MiBandApp.devices.DeviceManager;

import custom.freeyourgadget.MiBandApp.entities.DaoMaster;
import custom.freeyourgadget.MiBandApp.entities.DaoSession;
import custom.freeyourgadget.MiBandApp.entities.Device;

import custom.freeyourgadget.MiBandApp.externalevents.BluetoothStateChangeReceiver;
import custom.freeyourgadget.MiBandApp.impl.GBDevice;
import custom.freeyourgadget.MiBandApp.impl.GBDeviceService;
...
import custom.freeyourgadget.MiBandApp.service.NotificationCollectorMonitorService;
import custom.freeyourgadget.MiBandApp.util.AndroidUtils;
...
import custom.freeyourgadget.MiBandApp.util.LimitedQueue;
import custom.freeyourgadget.MiBandApp.util.Prefs;

import static custom.freeyourgadget.MiBandApp.model.DeviceType.AMAZFITBIP;
import static custom.freeyourgadget.MiBandApp.model.DeviceType.AMAZFITCOR;
import static custom.freeyourgadget.MiBandApp.model.DeviceType.AMAZFITCOR2;
import static custom.freeyourgadget.MiBandApp.model.DeviceType.MIBAND;
import static custom.freeyourgadget.MiBandApp.model.DeviceType.MIBAND2;
import static custom.freeyourgadget.MiBandApp.model.DeviceType.MIBAND3;
import static custom.freeyourgadget.MiBandApp.model.DeviceType.fromKey;
import static custom.freeyourgadget.MiBandApp.util.GB.NOTIFICATION_CHANNEL_HIGH_PRIORITY_ID;
import static custom.freeyourgadget.MiBandApp.util.GB.NOTIFICATION_CHANNEL_ID;
...
public class GBApplication extends Application {
    ...
    public static final String ACTION_QUIT
            = "custom.freeyourgadget.MiBandApp.gbapplication.action.quit";
    public static final String ACTION_LANGUAGE_CHANGE = "custom.freeyourgadget.MiBandApp.gbapplication.action.language_change";
    public static final String ACTION_NEW_DATA = "custom.freeyourgadget.MiBandApp.action.new_data";
    ...
    private void migratePrefs(int oldVersion) {
        ...
        if (oldVersion < 6) {
            ...
            migrateStringPrefToPerDevicePref("mi_button_press_broadcast", "custom.freeyourgadget.MiBandApp.ButtonPressed", "button_action_broadcast", new ArrayList<>(Collections.singletonList(MIBAND2)));
        }
        if (oldVersion < 7) {
