...
import custom.freeyourgadget.MiBandApp.service.devices.pebble.webview.GBChromeClient;
import custom.freeyourgadget.MiBandApp.service.devices.pebble.webview.GBWebClient;
import custom.freeyourgadget.MiBandApp.service.devices.pebble.webview.JSInterface;
...
public class ExternalPebbleJSActivity extends AbstractGBActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras == null) {
            ...
            if(confUri.getScheme().equals("MiBandApp")) {
                try {
