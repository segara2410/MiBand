...
package custom.freeyourgadget.MiBandApp.activities.appmanager;
...
import custom.freeyourgadget.MiBandApp.adapter.GBDeviceAppAdapter;
...
import custom.freeyourgadget.MiBandApp.service.devices.pebble.PebbleProtocol;
...
public abstract class AbstractAppManagerFragment extends Fragment {
    public static final String ACTION_REFRESH_APPLIST
            = "custom.freeyourgadget.MiBandApp.appmanager.action.refresh_applist";
