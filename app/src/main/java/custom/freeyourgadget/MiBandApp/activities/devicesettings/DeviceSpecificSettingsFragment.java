...
package custom.freeyourgadget.MiBandApp.activities.devicesettings;
...
import custom.freeyourgadget.MiBandApp.devices.makibeshr3.MakibesHR3Constants;
import custom.freeyourgadget.MiBandApp.devices.miband.MiBandConst;
import custom.freeyourgadget.MiBandApp.util.Prefs;
import custom.freeyourgadget.MiBandApp.util.XTimePreference;
import custom.freeyourgadget.MiBandApp.util.XTimePreferenceFragment;

import static custom.freeyourgadget.MiBandApp.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_ALTITUDE_CALIBRATE;
import static custom.freeyourgadget.MiBandApp.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_BUTTON_1_FUNCTION;
import static custom.freeyourgadget.MiBandApp.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_BUTTON_2_FUNCTION;
import static custom.freeyourgadget.MiBandApp.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_BUTTON_3_FUNCTION;
import static custom.freeyourgadget.MiBandApp.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_BUTTON_BP_CALIBRATE;
import static custom.freeyourgadget.MiBandApp.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DATEFORMAT;
import static custom.freeyourgadget.MiBandApp.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DISCONNECTNOTIF_NOSHED;
import static custom.freeyourgadget.MiBandApp.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_DO_NOT_DISTURB_NOAUTO;
import static custom.freeyourgadget.MiBandApp.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_HYBRID_HR_DRAW_WIDGET_CIRCLES;
import static custom.freeyourgadget.MiBandApp.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_HYBRID_HR_FORCE_WHITE_COLOR;
import static custom.freeyourgadget.MiBandApp.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_HYBRID_HR_SAVE_RAW_ACTIVITY_FILES;
import static custom.freeyourgadget.MiBandApp.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_LANGUAGE;
import static custom.freeyourgadget.MiBandApp.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_LIFTWRIST_NOSHED;
import static custom.freeyourgadget.MiBandApp.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_LONGSIT_PERIOD;
import static custom.freeyourgadget.MiBandApp.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_LONGSIT_SWITCH;
import static custom.freeyourgadget.MiBandApp.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_POWER_MODE;
import static custom.freeyourgadget.MiBandApp.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_SCREEN_ORIENTATION;
import static custom.freeyourgadget.MiBandApp.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_TIMEFORMAT;
import static custom.freeyourgadget.MiBandApp.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_VIBRATION_STRENGH_PERCENTAGE;
import static custom.freeyourgadget.MiBandApp.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_WEARLOCATION;
import static custom.freeyourgadget.MiBandApp.devices.huami.HuamiConst.PREF_ACTIVATE_DISPLAY_ON_LIFT;
import static custom.freeyourgadget.MiBandApp.devices.huami.HuamiConst.PREF_DISCONNECT_NOTIFICATION;
import static custom.freeyourgadget.MiBandApp.devices.huami.HuamiConst.PREF_DISCONNECT_NOTIFICATION_END;
import static custom.freeyourgadget.MiBandApp.devices.huami.HuamiConst.PREF_DISCONNECT_NOTIFICATION_START;
import static custom.freeyourgadget.MiBandApp.devices.huami.HuamiConst.PREF_DISPLAY_ITEMS;
import static custom.freeyourgadget.MiBandApp.devices.huami.HuamiConst.PREF_DISPLAY_ON_LIFT_END;
import static custom.freeyourgadget.MiBandApp.devices.huami.HuamiConst.PREF_DISPLAY_ON_LIFT_START;
import static custom.freeyourgadget.MiBandApp.devices.huami.HuamiConst.PREF_EXPOSE_HR_THIRDPARTY;
import static custom.freeyourgadget.MiBandApp.devices.huami.HuamiConst.PREF_SHORTCUTS;
import static custom.freeyourgadget.MiBandApp.devices.huami.HuamiConst.PREF_DEVICE_ACTION_FELL_SLEEP_SELECTION;
import static custom.freeyourgadget.MiBandApp.devices.huami.HuamiConst.PREF_DEVICE_ACTION_SELECTION_OFF;
import static custom.freeyourgadget.MiBandApp.devices.huami.HuamiConst.PREF_DEVICE_ACTION_SELECTION_BROADCAST;
import static custom.freeyourgadget.MiBandApp.devices.huami.HuamiConst.PREF_DEVICE_ACTION_FELL_SLEEP_BROADCAST;
import static custom.freeyourgadget.MiBandApp.devices.huami.HuamiConst.PREF_DEVICE_ACTION_START_NON_WEAR_BROADCAST;
import static custom.freeyourgadget.MiBandApp.devices.huami.HuamiConst.PREF_DEVICE_ACTION_START_NON_WEAR_SELECTION;
import static custom.freeyourgadget.MiBandApp.devices.huami.HuamiConst.PREF_DEVICE_ACTION_WOKE_UP_BROADCAST;
import static custom.freeyourgadget.MiBandApp.devices.huami.HuamiConst.PREF_DEVICE_ACTION_WOKE_UP_SELECTION;
import static custom.freeyourgadget.MiBandApp.devices.miband.MiBandConst.PREF_DO_NOT_DISTURB;
import static custom.freeyourgadget.MiBandApp.devices.miband.MiBandConst.PREF_DO_NOT_DISTURB_END;
import static custom.freeyourgadget.MiBandApp.devices.miband.MiBandConst.PREF_DO_NOT_DISTURB_OFF;
import static custom.freeyourgadget.MiBandApp.devices.miband.MiBandConst.PREF_DO_NOT_DISTURB_SCHEDULED;
import static custom.freeyourgadget.MiBandApp.devices.miband.MiBandConst.PREF_DO_NOT_DISTURB_START;
import static custom.freeyourgadget.MiBandApp.devices.miband.MiBandConst.PREF_MI2_DATEFORMAT;
import static custom.freeyourgadget.MiBandApp.devices.miband.MiBandConst.PREF_MI2_ROTATE_WRIST_TO_SWITCH_INFO;
import static custom.freeyourgadget.MiBandApp.devices.miband.MiBandConst.PREF_NIGHT_MODE;
import static custom.freeyourgadget.MiBandApp.devices.miband.MiBandConst.PREF_NIGHT_MODE_END;
import static custom.freeyourgadget.MiBandApp.devices.miband.MiBandConst.PREF_NIGHT_MODE_OFF;
import static custom.freeyourgadget.MiBandApp.devices.miband.MiBandConst.PREF_NIGHT_MODE_SCHEDULED;
import static custom.freeyourgadget.MiBandApp.devices.miband.MiBandConst.PREF_NIGHT_MODE_START;
import static custom.freeyourgadget.MiBandApp.devices.miband.MiBandConst.PREF_SWIPE_UNLOCK;
