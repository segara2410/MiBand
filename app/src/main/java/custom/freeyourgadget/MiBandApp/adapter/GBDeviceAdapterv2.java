...
package custom.freeyourgadget.MiBandApp.adapter;
...
import custom.freeyourgadget.MiBandApp.activities.ActivitySummariesActivity;
import custom.freeyourgadget.MiBandApp.activities.charts.ChartsActivity;
...
//        holder.heartRate.setVisibility(coordinator.supportsActivityTracking() ? View.VISIBLE : View.GONE);
//        holder.heartRate.setOnClickListener(v -> {
//            Intent startIntent;
//            startIntent = new Intent(context, HeartRateActivity.class);
//            startIntent.putExtra(GBDevice.EXTRA_DEVICE, device);
//            context.startActivity(startIntent);
//        });
...
//        }
        ...
        holder.removeDevice.setOnClickListener(v -> new AlertDialog.Builder(context)
                .setCancelable(true)
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        try {
                            ...
                            if (coordinator1 != null) {
                                coordinator1.deleteDevice(device);
                            }
        ...
        holder.setAlias.setOnClickListener(v -> {
            final EditText input = new EditText(context);
