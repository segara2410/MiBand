...
package custom.freeyourgadget.MiBandApp.devices;
...
public class DeviceManager {
    ...
    public static final String ACTION_DEVICES_CHANGED
            = "custom.freeyourgadget.MiBandApp.devices.devicemanager.action.devices_changed";
    /**
    ...
    public static final String ACTION_REFRESH_DEVICELIST
            = "custom.freeyourgadget.MiBandApp.devices.devicemanager.action.set_version";
