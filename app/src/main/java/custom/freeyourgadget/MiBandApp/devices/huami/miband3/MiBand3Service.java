/*  Copyright (C) 2015-2020 Andreas Shimokawa, Carsten Pfeiffer, José Rebelo
...
package custom.freeyourgadget.MiBandApp.devices.huami.miband3;

import static custom.freeyourgadget.MiBandApp.devices.huami.HuamiService.DISPLAY_ITEM_BIT_CLOCK;
import static custom.freeyourgadget.MiBandApp.devices.huami.HuamiService.ENDPOINT_DISPLAY;
import static custom.freeyourgadget.MiBandApp.devices.huami.HuamiService.ENDPOINT_DISPLAY_ITEMS;
