/*  Copyright (C) 2018-2020 Andreas Shimokawa, Vadim Kaushan
...
package custom.freeyourgadget.MiBandApp.devices.id115;

import java.util.UUID;

import custom.freeyourgadget.MiBandApp.model.NotificationType;

import static custom.freeyourgadget.MiBandApp.service.btle.AbstractBTLEDeviceSupport.BASE_UUID;
