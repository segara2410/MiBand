...
public class LenovoWatchConstants {
    ...
    public static final String ACTION_CALIBRATION
            = "custom.freeyourgadget.MiBandApp.devices.action.lenovowatch.start_calibration";
    public static final String ACTION_CALIBRATION_SEND
            = "custom.freeyourgadget.MiBandApp.devices.action.lenovowatch.send_calibration";
    public static final String ACTION_CALIBRATION_HOLD
            = "custom.freeyourgadget.MiBandApp.devices.action.lenovowatch.keep_calibrating";
