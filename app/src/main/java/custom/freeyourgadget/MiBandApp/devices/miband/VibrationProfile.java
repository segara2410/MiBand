/*  Copyright (C) 2015-2020 Andreas Shimokawa, Carsten Pfeiffer, Uwe Hermann
...
import custom.freeyourgadget.MiBandApp.service.btle.profiles.alertnotification.AlertLevel;
