...
public final class Watch9Constants {
    ...
    public static final String ACTION_CALIBRATION
            = "custom.freeyourgadget.MiBandApp.devices.action.watch9.start_calibration";
    public static final String ACTION_CALIBRATION_SEND
            = "custom.freeyourgadget.MiBandApp.devices.action.watch9.send_calibration";
    public static final String ACTION_CALIBRATION_HOLD
            = "custom.freeyourgadget.MiBandApp.devices.action.watch9.keep_calibrating";
