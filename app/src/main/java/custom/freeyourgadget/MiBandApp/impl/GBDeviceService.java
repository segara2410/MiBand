/*  Copyright (C) 2015-2020 Alberto, Andreas Böhler, Andreas Shimokawa,
...
package custom.freeyourgadget.MiBandApp.impl;
...
import custom.freeyourgadget.MiBandApp.util.LanguageUtils;
import custom.freeyourgadget.MiBandApp.util.RtlUtils;

import static custom.freeyourgadget.MiBandApp.util.JavaExtensions.coalesce;
