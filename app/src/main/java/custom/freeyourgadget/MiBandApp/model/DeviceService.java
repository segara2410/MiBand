...
package custom.freeyourgadget.MiBandApp.model;

import androidx.annotation.Nullable;

import custom.freeyourgadget.MiBandApp.devices.EventHandler;
...
public interface DeviceService extends EventHandler {
    String PREFIX = "custom.freeyourgadget.MiBandApp.devices";
    ...
    String ACTION_SET_HEARTRATE_MEASUREMENT_INTERVAL = PREFIX + ".action.set_heartrate_measurement_interval";
