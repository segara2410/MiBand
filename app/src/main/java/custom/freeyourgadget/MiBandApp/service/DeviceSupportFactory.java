...
import custom.freeyourgadget.MiBandApp.service.devices.banglejs.BangleJSDeviceSupport;
import custom.freeyourgadget.MiBandApp.service.devices.casiogb6900.CasioGB6900DeviceSupport;
import custom.freeyourgadget.MiBandApp.service.devices.hplus.HPlusSupport;
import custom.freeyourgadget.MiBandApp.service.devices.huami.HuamiSupport;
import custom.freeyourgadget.MiBandApp.service.devices.huami.amazfitbip.AmazfitBipLiteSupport;
import custom.freeyourgadget.MiBandApp.service.devices.huami.amazfitbips.AmazfitBipSSupport;
import custom.freeyourgadget.MiBandApp.service.devices.huami.amazfitbip.AmazfitBipSupport;
import custom.freeyourgadget.MiBandApp.service.devices.huami.amazfitgtr.AmazfitGTRLiteSupport;
import custom.freeyourgadget.MiBandApp.service.devices.huami.amazfitgtr.AmazfitGTRSupport;
import custom.freeyourgadget.MiBandApp.service.devices.huami.amazfittrex.AmazfitTRexSupport;
import custom.freeyourgadget.MiBandApp.service.devices.huami.amazfitcor.AmazfitCorSupport;
import custom.freeyourgadget.MiBandApp.service.devices.huami.amazfitcor2.AmazfitCor2Support;
import custom.freeyourgadget.MiBandApp.service.devices.huami.amazfitgts.AmazfitGTSSupport;
import custom.freeyourgadget.MiBandApp.service.devices.huami.miband3.MiBand3Support;
import custom.freeyourgadget.MiBandApp.service.devices.huami.miband4.MiBand4Support;
import custom.freeyourgadget.MiBandApp.service.devices.huami.miband5.MiBand5Support;
import custom.freeyourgadget.MiBandApp.service.devices.id115.ID115Support;
import custom.freeyourgadget.MiBandApp.service.devices.itag.ITagSupport;
import custom.freeyourgadget.MiBandApp.service.devices.jyou.BFH16DeviceSupport;
import custom.freeyourgadget.MiBandApp.service.devices.jyou.TeclastH30.TeclastH30Support;
import custom.freeyourgadget.MiBandApp.service.devices.liveview.LiveviewSupport;
import custom.freeyourgadget.MiBandApp.service.devices.makibeshr3.MakibesHR3DeviceSupport;
import custom.freeyourgadget.MiBandApp.service.devices.miband.MiBandSupport;
import custom.freeyourgadget.MiBandApp.service.devices.mijia_lywsd02.MijiaLywsd02Support;
import custom.freeyourgadget.MiBandApp.service.devices.miscale2.MiScale2DeviceSupport;
import custom.freeyourgadget.MiBandApp.service.devices.no1f1.No1F1Support;
import custom.freeyourgadget.MiBandApp.service.devices.pebble.PebbleSupport;
import custom.freeyourgadget.MiBandApp.service.devices.pinetime.PineTimeJFSupport;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.QHybridSupport;
import custom.freeyourgadget.MiBandApp.service.devices.roidmi.RoidmiSupport;
import custom.freeyourgadget.MiBandApp.service.devices.tlw64.TLW64Support;
import custom.freeyourgadget.MiBandApp.service.devices.vibratissimo.VibratissimoSupport;
import custom.freeyourgadget.MiBandApp.service.devices.watch9.Watch9DeviceSupport;
import custom.freeyourgadget.MiBandApp.service.devices.jyou.y5.Y5Support;
import custom.freeyourgadget.MiBandApp.service.devices.lenovo.watchxplus.WatchXPlusDeviceSupport;
import custom.freeyourgadget.MiBandApp.service.devices.xwatch.XWatchSupport;
import custom.freeyourgadget.MiBandApp.service.devices.zetime.ZeTimeDeviceSupport;
