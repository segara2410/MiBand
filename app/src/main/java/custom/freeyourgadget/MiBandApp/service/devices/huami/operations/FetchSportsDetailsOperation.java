...
package custom.freeyourgadget.MiBandApp.service.devices.huami.operations;
...
import custom.freeyourgadget.MiBandApp.entities.BaseActivitySummary;
import custom.freeyourgadget.MiBandApp.export.ActivityTrackExporter;
import custom.freeyourgadget.MiBandApp.export.GPXExporter;
import custom.freeyourgadget.MiBandApp.model.ActivityKind;
import custom.freeyourgadget.MiBandApp.model.ActivityTrack;
...
import custom.freeyourgadget.MiBandApp.service.devices.huami.HuamiActivityDetailsParser;
...
//        }
        ...
        if (success) {
            ...
            try {
                ...
                String fileName = FileUtils.makeValidFileName("MiBandApp-"+trackType.toLowerCase()+"-" + DateTimeUtils.formatIso8601(summary.getStartTime()) + ".gpx");
