/*  Copyright (C) 2018-2020 Andreas Shimokawa, Carsten Pfeiffer, Sebastian
    Kranz, Vadim Kaushan
...
package custom.freeyourgadget.MiBandApp.service.devices.id115;
...
import custom.freeyourgadget.MiBandApp.devices.id115.ID115Constants;
