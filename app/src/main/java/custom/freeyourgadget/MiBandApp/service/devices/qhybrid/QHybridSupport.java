...
package custom.freeyourgadget.MiBandApp.service.devices.qhybrid;
...
import custom.freeyourgadget.MiBandApp.BuildConfig;
...
import custom.freeyourgadget.MiBandApp.model.RecordedDataTypes;
...
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.adapter.WatchAdapterFactory;
...
public class QHybridSupport extends QHybridBaseSupport {
    ...
    public static final String QHYBRID_COMMAND_UPDATE_SETTINGS = "custom.freeyourgadget.MiBandApp.Q_UPDATE_SETTINGS";
    public static final String QHYBRID_COMMAND_OVERWRITE_BUTTONS = "custom.freeyourgadget.MiBandApp.Q_OVERWRITE_BUTTONS";
    public static final String QHYBRID_COMMAND_UPDATE_WIDGETS = "custom.freeyourgadget.MiBandApp.Q_UPDATE_WIDGETS";
    public static final String QHYBRID_COMMAND_SET_MENU_MESSAGE = "custom.freeyourgadget.MiBandApp.Q_SET_MENU_MESSAGE";
    public static final String QHYBRID_COMMAND_SEND_MENU_ITEMS = "custom.freeyourgadget.MiBandApp.Q_SEND_MENU_ITEMS";
    public static final String QHYBRID_COMMAND_SET_WIDGET_CONTENT = "custom.freeyourgadget.MiBandApp.Q_SET_WIDGET_CONTENT";
    public static final String QHYBRID_COMMAND_SET_BACKGROUND_IMAGE = "custom.freeyourgadget.MiBandApp.Q_SET_BACKGROUND_IMAGE";

    private static final String QHYBRID_ACTION_SET_ACTIVITY_HAND = "custom.freeyourgadget.MiBandApp.Q_SET_ACTIVITY_HAND";

    public static final String QHYBRID_EVENT_SETTINGS_UPDATED = "custom.freeyourgadget.MiBandApp.Q_SETTINGS_UPDATED";
    public static final String QHYBRID_EVENT_FILE_UPLOADED = "custom.freeyourgadget.MiBandApp.Q_FILE_UPLOADED";
    public static final String QHYBRID_COMMAND_NOTIFICATION_CONFIG_CHANGED = "custom.freeyourgadget.MiBandApp.Q_NOTIFICATION_CONFIG_CHANGED";

    public static final String QHYBRID_EVENT_BUTTON_PRESS = "custom.freeyourgadget.MiBandApp.Q_BUTTON_PRESSED";
    public static final String QHYBRID_EVENT_MULTI_BUTTON_PRESS = "custom.freeyourgadget.MiBandApp.Q_MULTI_BUTTON_PRESSED";
    public static final String QHYBRID_EVENT_COMMUTE_MENU = "custom.freeyourgadget.MiBandApp.Q_COMMUTE_MENU";
