...
package custom.freeyourgadget.MiBandApp.service.devices.qhybrid.adapter.fossil;
...
import custom.freeyourgadget.MiBandApp.devices.qhybrid.PackageConfigHelper;
...
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.buttonconfig.ConfigFileBuilder;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.buttonconfig.ConfigPayload;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.Request;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.fossil.FossilRequest;
...
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.fossil.alarm.AlarmsSetRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.fossil.configuration.ConfigurationPutRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.fossil.file.FilePutRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.fossil.notification.NotificationFilterPutRequest;
...
import static custom.freeyourgadget.MiBandApp.service.devices.qhybrid.QHybridSupport.ITEM_TIMEZONE_OFFSET;
...
import static custom.freeyourgadget.MiBandApp.service.devices.qhybrid.QHybridSupport.QHYBRID_EVENT_MULTI_BUTTON_PRESS;
...
public class FossilWatchAdapter extends WatchAdapter {
    ...
    public void vibrate(custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.PlayNotificationRequest.VibrationType vibration) {
        // queueWrite(new custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.PlayNotificationRequest(vibration, -1, -1));
    }
    ...
    public void onSetAlarms(ArrayList<? extends Alarm> alarms) {
       //  throw new RuntimeException("noope");
        ArrayList<custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.fossil.alarm.Alarm> activeAlarms = new ArrayList<>();
        for (Alarm alarm : alarms){
            if(!alarm.getEnabled()) continue;
            if(alarm.getRepetition() == 0){
                activeAlarms.add(new custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.fossil.alarm.Alarm(
        ...
        queueWrite(new AlarmsSetRequest(activeAlarms.toArray(new custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.fossil.alarm.Alarm[0]), this){
            @Override
            public void onFilePut(boolean success) {
                super.onFilePut(success);
