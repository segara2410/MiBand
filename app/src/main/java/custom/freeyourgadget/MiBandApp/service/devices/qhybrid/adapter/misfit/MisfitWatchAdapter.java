...
package custom.freeyourgadget.MiBandApp.service.devices.qhybrid.adapter.misfit;
...
import custom.freeyourgadget.MiBandApp.devices.DeviceManager;
import custom.freeyourgadget.MiBandApp.devices.qhybrid.NotificationConfiguration;
import custom.freeyourgadget.MiBandApp.impl.GBDevice;
import custom.freeyourgadget.MiBandApp.model.Alarm;
import custom.freeyourgadget.MiBandApp.model.BatteryState;
import custom.freeyourgadget.MiBandApp.model.GenericItem;
...
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.adapter.WatchAdapter;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.Request;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.ActivityPointGetRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.AnimationRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.BatteryLevelRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.DownloadFileRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.EraseFileRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.FileRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.GetCountdownSettingsRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.GetCurrentStepCountRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.GetStepGoalRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.GetVibrationStrengthRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.GoalTrackingGetRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.ListFilesRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.MoveHandsRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.OTAEnterRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.OTAEraseRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.PlayNotificationRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.ReleaseHandsControlRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.RequestHandControlRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.SetCurrentStepCountRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.SetStepGoalRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.SetTimeRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.SetVibrationStrengthRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.UploadFileRequest;
import custom.freeyourgadget.MiBandApp.service.devices.qhybrid.requests.misfit.VibrateRequest;
import custom.freeyourgadget.MiBandApp.util.FileUtils;
import custom.freeyourgadget.MiBandApp.util.GB;

import static custom.freeyourgadget.MiBandApp.service.devices.qhybrid.QHybridSupport.ITEM_ACTIVITY_POINT;
import static custom.freeyourgadget.MiBandApp.service.devices.qhybrid.QHybridSupport.ITEM_STEP_COUNT;
import static custom.freeyourgadget.MiBandApp.service.devices.qhybrid.QHybridSupport.ITEM_STEP_GOAL;
import static custom.freeyourgadget.MiBandApp.service.devices.qhybrid.QHybridSupport.ITEM_VIBRATION_STRENGTH;
import static custom.freeyourgadget.MiBandApp.service.devices.qhybrid.QHybridSupport.QHYBRID_EVENT_BUTTON_PRESS;
import static custom.freeyourgadget.MiBandApp.service.devices.qhybrid.QHybridSupport.QHYBRID_EVENT_FILE_UPLOADED;
