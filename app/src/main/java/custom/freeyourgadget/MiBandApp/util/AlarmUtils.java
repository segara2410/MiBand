...
public class AlarmUtils {
     ...
     * @return
     */
    public static custom.freeyourgadget.MiBandApp.model.Alarm createSingleShot(int index, boolean smartWakeup, boolean snooze, Calendar calendar) {
     ...
     * @return
     */
    public static Calendar toCalendar(custom.freeyourgadget.MiBandApp.model.Alarm alarm) {
