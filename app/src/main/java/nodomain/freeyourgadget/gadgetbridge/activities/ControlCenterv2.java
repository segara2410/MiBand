...
import nodomain.freeyourgadget.gadgetbridge.activities.discover.DiscoveryActivity;
import nodomain.freeyourgadget.gadgetbridge.activities.discover.PolarDiscoveryActivity;
...
public class ControlCenterv2 extends AppCompatActivity
    ...
    private void initCustomDialog(){
        customDialog = new Dialog(ControlCenterv2.this);
        customDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        customDialog.setContentView(R.layout.device_type);

        customDialog.findViewById(R.id.miband).setOnClickListener(v -> {
            launchDiscoveryActivity();
            customDialog.dismiss();
        });

        customDialog.findViewById(R.id.polar).setOnClickListener(v -> {
            launchPolarDiscovery();
            customDialog.dismiss();
        });
    }
...
//                return true;
    ...
    private void launchPolarDiscovery() {
        startActivity(new Intent(this, PolarDiscoveryActivity.class));
    }
