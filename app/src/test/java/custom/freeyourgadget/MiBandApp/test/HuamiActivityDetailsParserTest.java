...
import custom.freeyourgadget.MiBandApp.devices.amazfitbip.BipActivitySummary;
...
import custom.freeyourgadget.MiBandApp.model.ActivityPoint;
...
public class HuamiActivityDetailsParserTest extends TestBase {
    ...
    public void testGPXExport() throws Exception {
        ...
        try (InputStream in = getContents(DETAILS_1)) {
            ...
            File targetFile = File.createTempFile("MiBandApp-track", ".gpx");
